...
class ResultPrinter
{
     ...
     */
    public static function printOutput($title, $objectName, $request, $response = null, $errorMessage = null)
    {
     ...
     * @param mixed     $response
     */
    public static function printResult($title, $objectName, $request, $response = null)
    {
        self::printOutput($title, $objectName, $request, $response, false);
    }
